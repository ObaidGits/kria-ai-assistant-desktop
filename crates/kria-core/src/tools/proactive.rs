...
#[async_trait]
impl ToolHandler for GetAlerts {
...
#[async_trait]
impl ToolHandler for DismissAlert {
    async fn execute(&self, params: serde_json::Value) -> ToolResult {
...
#[async_trait]
impl ToolHandler for WatchDirectory {
    async fn execute(&self, params: serde_json::Value) -> ToolResult {
...
struct ListWatchedDirs {
    engine: Arc<ProactiveEngine>,
}
#[async_trait]
impl ToolHandler for ListWatchedDirs {
    async fn execute(&self, _params: serde_json::Value) -> ToolResult {
...
struct SmartSuggest;
#[async_trait]
impl ToolHandler for SmartSuggest {
    async fn execute(&self, params: serde_json::Value) -> ToolResult {
        ...
        let suggestions: Vec<&str> = match hour {
            6..=9 => vec![
                ...
                "Review yesterday's git changes",
                "Check disk space",
            ],
    ...
    let tools: Vec<(ToolDef, Arc<dyn ToolHandler>)> = vec![
        (
            ToolDef {
                ...
                description: "Run system health checks (RAM, disk) and return any alerts".into(),
        ...
        (
            ToolDef {
                ...
                description: "Get all proactive alerts and notifications".into(),
                category: "proactive".into(),
                default_tier: RiskLevel::Green,
                min_tier: "lite",
        ...
        (
            ToolDef {
                ...
                description: "Dismiss a proactive alert by ID".into(),
                category: "proactive".into(),
                default_tier: RiskLevel::Green,
                min_tier: "lite",
                parameters: vec![param("id", "string", "Alert ID to dismiss", true)],
            },
            Arc::new(DismissAlert {
                engine: engine.clone(),
            }),
        ),
        (
            ToolDef {
                ...
                description: "Watch a directory for file changes and new files".into(),
                category: "proactive".into(),
                default_tier: RiskLevel::Green,
                min_tier: "standard",
                parameters: vec![
                    ...
                    param(
                        "label",
                        "string",
                        "Label for this watch (e.g., 'Downloads')",
                        false,
                    ),
                ],
            },
            Arc::new(WatchDirectory {
                engine: engine.clone(),
            }),
        ),
        (
            ToolDef {
                ...
                description: "List all watched directories".into(),
                category: "proactive".into(),
                default_tier: RiskLevel::Green,
                min_tier: "lite",
                parameters: vec![],
            },
            Arc::new(ListWatchedDirs {
                engine: engine.clone(),
            }),
        ),
        (
            ToolDef {
                ...
                description: "Get smart suggestions based on time of day and context".into(),
                category: "proactive".into(),
                default_tier: RiskLevel::Green,
                min_tier: "lite",
                parameters: vec![param(
